        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
             ...
             // Compute tax for marriedjointly filers
               if (income <= 18550){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
               ...
               else if (income <= 15190) {
                 tax = 18550 * 0.10 + (75300 - 9275) * 0.15 + (income - 75300) * 0.25;
                 taxRate = 25;
               } //end of else if
               else if (income <= 231450) {
                 tax = 18550 * 0.10 + (75300 - 9275) * 0.15 +
                       (15190 - 75300) * 0.25 + (income - 15190) * 0.28;
                 taxRate = 28;
               }//end of else if
               else if (income <= 413350) {
                 tax = 18550 * 0.10 + (75300 - 9275) * 0.15 +
                       (15190 - 75300) * 0.25 + (231450 - 15190) * 0.28 +
                       (income - 231450) * 0.33;
                 taxRate = 33;
               }//end of else if
...
function clearButton () {
             ...
             document.getElementById("taxEstimate").innerHTML = "Tax:  <b>$" + 0.00 + "<b></br><br>";
          
          document.getElementById("taxBracket").innerHTML = "Tax Bracket: <b>" + 0 + "</b>%";
